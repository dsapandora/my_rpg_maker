...
import myrpgmaker.editor.Internationalized.needsTranslation
import myrpgmaker.editor.StateMaster
import myrpgmaker.editor.dialog.ConditionsPanel
import myrpgmaker.editor.dialog.cmd.EventCmdCategory.Battles
import myrpgmaker.editor.dialog.cmd.EventCmdCategory.Effects
import myrpgmaker.editor.dialog.cmd.EventCmdCategory.GameState
import myrpgmaker.editor.dialog.cmd.EventCmdCategory.Input
import myrpgmaker.editor.dialog.cmd.EventCmdCategory.Inventory
import myrpgmaker.editor.dialog.cmd.EventCmdCategory.Movement
import myrpgmaker.editor.dialog.cmd.EventCmdCategory.Party
import myrpgmaker.editor.dialog.cmd.EventCmdCategory.Programming
import myrpgmaker.editor.dialog.cmd.EventCmdCategory.Windows
...
import myrpgmaker.editor.resourceselector.PictureField
import myrpgmaker.editor.resourceselector.SoundField
import myrpgmaker.editor.resourceselector.WindowskinField
import myrpgmaker.editor.uibase.ArrayMultiselectPanel
import myrpgmaker.editor.uibase.EntitySelectPanel
import myrpgmaker.editor.uibase.EventParameterField
import myrpgmaker.editor.uibase.EventParameterField._
import myrpgmaker.editor.uibase.FloatSpinner
import myrpgmaker.editor.uibase.LayoutEditingPanel
import myrpgmaker.editor.uibase.NumberSpinner
import myrpgmaker.editor.uibase.StringArrayEditingPanel
import myrpgmaker.editor.uibase.SwingUtils.boolEnumHorizBox
import myrpgmaker.editor.uibase.SwingUtils.boolField
import myrpgmaker.editor.uibase.SwingUtils.colorField
import myrpgmaker.editor.uibase.SwingUtils.enumVerticalBox
import myrpgmaker.editor.uibase.SwingUtils.indexedCombo
import myrpgmaker.editor.uibase.SwingUtils.percentField
import myrpgmaker.editor.uibase.SwingUtils.textAreaField
import myrpgmaker.editor.uibase.SwingUtils.textField
import myrpgmaker.lib.ArrayUtils
import myrpgmaker.model.AddOrRemove
import myrpgmaker.model.ColorSpec
import myrpgmaker.model.EnabledDisabledEnum
import myrpgmaker.model.EntityInfoEnum
import myrpgmaker.model.EquipOrUnequip
import myrpgmaker.model.HealOrDamageEnum
import myrpgmaker.model.MapLoc
import myrpgmaker.model.MusicSlots
import myrpgmaker.model.Origins
import myrpgmaker.model.PictureSlots
import myrpgmaker.model.RpgMapData
import myrpgmaker.model.Transitions
import myrpgmaker.model.WeatherTypes
import myrpgmaker.model.event._
import myrpgmaker.player.MyKeysEnum
...
object GetKeyInputUI extends EventCmdUI[GetKeyInput] {
  import myrpgmaker.model.HasName._
