package myrpgmaker.editor.util

import java.io.File
import org.apache.commons.io.FileUtils
import com.google.common.io.Files
import myrpgmaker.model.Project
import myrpgmaker.save.SaveFile
...
object Export {
  ...
  def export(project: Project, executableJarFile: File): Unit = {
    ...
    val libraryJarName = "myrpgmaker-library.jar"
    ...
    generatePackage("linux-mac", "exportresources/linux/launch.sh", "myrpgmaker", true)
    generatePackage("windows", "exportresources/win/myrpgmaker-player.exe",
        "myrpgmaker.exe", false)
  }
}