...
object ResourceConstants {
  ...
  def getProjectDataStartup = ProjectDataStartup(
    ...
    soundCursor =
      Some(SoundSpec("sys/myrpgmaker-menu/MenuCursor.ogg")),
    soundSelect =
      Some(SoundSpec("sys/myrpgmaker-menu/MenuSelect.ogg")),
    soundCancel =
      Some(SoundSpec("sys/myrpgmaker-menu/MenuCancel.ogg")),
    soundCannot =
      Some(SoundSpec("sys/myrpgmaker-menu/MenuCannot.ogg")))
